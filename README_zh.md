...
>   3. 参赛论文和代码（尽信书不如无书，希望大家对我们论文**批判性阅读**，取长补短，在博客里赛后复盘我其实感觉我们有很多点没做好，希望后来者能够吸取我们的经验教训做得更好），此外读完我们文章之后建议再去找一下本题的o奖论文，横向对比一下其他人的解决方案。
...
### 开始方法二（更推荐采用的方式）
1. 点击项目首页（需要切换到上一个页面，即点击切换为中文readme之前的页面）右上方的绿色“code”，再点击“download ZIP”直接本地下载安装包并解压
2. 在VS Code中打开解压后的项目文件夹即可本地运行本项目（需要提前在vscode中安装jupyter和latex相关扩展，具体步骤请自行在大模型指导下进行）

*注：考虑到对本项目感兴趣的可能多为刚接触美赛的本科低年级同学，故更推荐使用这种不使用git的方式，直接下载压缩包到本地即可开始运行*
